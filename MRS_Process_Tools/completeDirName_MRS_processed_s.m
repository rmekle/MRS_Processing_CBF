...
%
%% Function to complete directory name for processed magnetic resonance spectroscopy (MRS) data
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% USAGE
...
% signals	   = String describing MRS signals to be processed:
%					'Spectra'	= MR spectra
%					'MMs'		= Acquired macromolecules (MMs)
% leftshift	   = ['Leftshift'] # of points to leftshift all FIDs, i.e. to remove leading 
%					 datapoints from the FID  to get rid of 1st order phase.
...
% strSpecReg   = ['SpectralRegistrationID'] Character array that specifies ID,
%					i.e. name, of spectral registration (drift correction) that might be 
%					performed to distinguish results.
% driftCorr	   = ['DriftCorrection'] Character array that specifies whether 
